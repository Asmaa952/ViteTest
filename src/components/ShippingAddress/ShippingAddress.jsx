...
export default function Login() {
 ...
 const validationSchema = Yup.object({
   ...
   phone: Yup.string().required("Password is requried"),
         ...
         <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
          ...
          <div className="flex items-start flex-col justify-start">
            ...
            {touched.phone && errors.phone &&<p className='text-red-500'>{errors.phone}</p>}
             ...
             <button type="submit" className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-md shadow-sm disabled:bg-gray-500" disabled={isLoding}>Chack Out {isLoding && <i className='fas fa-spinner fa-spin'></i>}</button>
