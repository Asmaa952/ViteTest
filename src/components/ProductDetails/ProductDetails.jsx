        ...
        <div className="container mx-auto px-6">
            <div className="md:flex md:items-center">
                ...
                <div className="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-9/12">
                    ...
                    <button onClick={() =>  AddProductToWishList(productDetails._id, userToken)} className="mt-4 px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500">Add To WishList</button>
                </div>
            </div>
